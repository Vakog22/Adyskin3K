...
namespace Task13Test
{
    ...
    public class UnitTest1
    {
        ...
        {
            double val = Task13Console.Program.Mul(2,2);//Обращение к Task13Console и вызов метода
        ...
        {
            double val = Task13Console.Program.Mul(2.1, 2.3);
        ...
        {
            double val = Task13Console.Program.Mul(0, 100);
        ...
        {
            double val = Task13Console.Program.Mul(-2, 1.5);
        ...
        {
            double val = Task13Console.Program.Mul(-1, -1);
